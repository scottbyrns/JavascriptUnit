...
function debug (object) {
	// TODO implement debugger for exceptions thrown by tests.
	//
	// loop object
	// find methods on objects and in prototypes
	// count depth n to methods.
	// wrap methods in closure with reference to current n value
	// broadcast aop message with depth, call trace, and execution paramaters
}
